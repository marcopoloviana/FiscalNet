...
namespace FiscalNet.Implementacoes
{
    public class ConjuntosCST
    {
        ...
        private List<KeyValuePair<int, string>> IPI_CST_ENTRADA()
        {
            List<KeyValuePair<int, string>> result = new List<KeyValuePair<int, string>>();
        ...
        private List<KeyValuePair<int, string>> IPI_CST_SAIDA()
        {
            List<KeyValuePair<int, string>> result = new List<KeyValuePair<int, string>>();
